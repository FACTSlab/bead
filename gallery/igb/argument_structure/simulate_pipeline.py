...
def run_simulation(
    ...
    convergence_detector = ConvergenceDetector(
        human_agreement_metric="cohens_kappa",  # Using accuracy as proxy for kappa
    ...
    print("  Model: ForcedChoiceModel (Davlan/afro-xlmr-small)")
    print()
    ...
    for iteration in range(max_iterations):
        ...
        def predict_fn(model, item):
            return model.predict_proba([item])[0]
