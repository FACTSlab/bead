...
def test_rating_plugin_exists() -> None:
    ...
    plugin_path = Path("bead/deployment/jspsych/plugins/rating.js")
...
def test_rating_plugin_syntax() -> None:
    ...
    assert "jsPsychBeadRating" in content
...
def test_cloze_plugin_exists() -> None:
    ...
    plugin_path = Path("bead/deployment/jspsych/plugins/cloze-dropdown.js")
    assert plugin_path.exists()
...
def test_cloze_plugin_syntax() -> None:
    ...
    # Check for key plugin elements
    assert "jsPsychBeadClozeMulti" in content
...
def test_forced_choice_plugin_exists() -> None:
    ...
    plugin_path = Path("bead/deployment/jspsych/plugins/forced-choice.js")
    assert plugin_path.exists()
...
def test_forced_choice_plugin_syntax() -> None:
    ...
    # Check for key plugin elements
    assert "jsPsychBeadForcedChoice" in content
...
def test_all_plugins_have_version() -> None:
    ...
    plugin_dir = Path("bead/deployment/jspsych/plugins")
