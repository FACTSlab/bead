...
From [gallery/eng/argument_structure/fill_templates.py](../../../gallery/eng/argument_structure/fill_templates.py):
...
- [Gallery example](../../../gallery/eng/argument_structure/fill_templates.py): Full working script
